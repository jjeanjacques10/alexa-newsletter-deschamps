...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Estou aqui para lhe dar as melhores notícias de tecnologia';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Tchau turminha!';
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Desculpe, eu não sei te ajudar com isso. Tente novamente';
